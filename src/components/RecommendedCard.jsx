...
function RecommendedCard ({ imageClass, name, desc, index }) {
  ...
  return (
    <div className={`w-48 h-64 shadow-md rounded-lg shrink-0 transform transition hover:-translate-y-4 hover:shadow-xl overflow-visible ${isOdd ? 'bg-secondary text-white' : 'bg-white text-primary'}`}>
